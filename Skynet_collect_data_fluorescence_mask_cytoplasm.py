...
# Welcome Message
print('')
print('\033[1;34;40mYou accessed subroutine "19": Quantify fluoresence intensity in cytoplasm mask. \033[1;37;40m \n')
...
def make_and_save_quantification(mask_input_path, image_input_path, output_path, current_index, cell_mask_names, image_names):
    ...
    column_names.append('cytoplasm_area')
    ...
    for current_channel in range(channel_input_number):
        ...
        column_names.append(''.join(['integrated_cytoplasm_intensity_',channel_string]))
        column_names.append(''.join(['mean_cytoplasm_intensity_',channel_string]))
    ...
    data_name = ''.join([prefix,'_cy_quantification.csv'])
...
cell_mask_names = [x for x in mask_names if re.search('_cytoplasm', x)];
...
# Say goodbye
print('\033[1;34;40mSubroutine "19" completed. \033[1;37;40m \n')
